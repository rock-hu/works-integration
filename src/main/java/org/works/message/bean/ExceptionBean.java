/*
 * $Id: ExceptionBean.java 19191 2010-08-25 21:05:23Z tcarlson $
 * --------------------------------------------------------------------------------------
...
/**
 * The <code>ExceptionBean</code> is a POJO representing the details of a
 * Throwable
 */
public class ExceptionBean {
	...
	public ExceptionBean(Throwable exception) {
		...
		setStackTrace((showRootStackOnly ? null : getStackAsString(exception
				.getStackTrace())));
	...
	public Throwable toException() throws InstantiationException {
		if (originalException == null) {
			...
			try {
				...
				if (cause == null) {
					t = (Throwable) ClassUtils.instanciateClass(aClass,
							getDetailMessage());
				} else {
					t = (Throwable) ClassUtils.instanciateClass(aClass,
							getDetailMessage(), cause.toException());
				}
				...
				throw new InstantiationException(
						"Failed to create Exception from ExceptionBean: "
								+ e.getMessage());
			}
		}
