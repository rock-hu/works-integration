/*
 * $Id: LocaleMessage.java 20321 2010-11-24 15:21:24Z dfeist $
 * --------------------------------------------------------------------------------------
...
import org.works.message.handler.ExceptionHandler;
...
public class LocaleMessage extends MessageFactory {
	...
	public static String unhandledException(Class<?> class1, Class<?> class2) {
		return factory.getString(BUNDLE_PATH, 2,
				StringMessageUtils.toString(class1),
	...
	public static String handlerFailure(ExceptionHandler eh) {
		String handlerDescription = ObjectUtils.toString(eh.getClass()
				.getName(), "null");
	...
	public static String defaultHandling(Class<?> class1, ExceptionHandler eh,
			Exception e) {
		return factory.getString(BUNDLE_PATH, 9, StringMessageUtils
				.toString(class1), ObjectUtils.toString(eh.getClass().getName()
				+ " : " + e, "null"));
	}
