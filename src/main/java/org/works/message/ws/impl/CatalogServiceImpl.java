...
import org.works.message.processor.CatalogAdminService;
import org.works.message.ws.CatalogService;
...
public class CatalogServiceImpl implements CatalogService, CatalogAdminService,
		Initialisable {
	/**
	 * Simple hashmap used to store the catalog, in real life this would be a
	 * database
	 */
	...
	public void initialise() throws InitialisationException {
		...
		addBook(new Book("C.S. Lewis", "The Lion, the Witch and the Wardrobe",
				6));
